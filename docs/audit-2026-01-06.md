...
## 6. Applications (Complete Inventory)

### Critical / Daily Use

| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **Raycast** | Cask | ✅ Essential | Launcher, productivity |
| **Obsidian** | Cask | ✅ Essential | Knowledge base |
| **Obsidian Web Clipper** | App Store | ✅ Essential | Web clipping |
| **Ghostty** | Cask | ✅ Essential | Primary terminal |
| **Chrome** | Direct | ✅ Essential | Primary browser |
| **Zen** | Direct | ✅ Used | Backup browser |
| **VoiceInk** | Cask | ✅ Essential | Voice to text |
| **1Password** | App Store | ✅ Essential | Password manager |
| **1password-cli** | Cask | ✅ Essential | CLI integration |
| **Tailscale** | Direct | ✅ Essential | VPN |

### AI/LLM Tools (must-haves on ALL systems)

| App | Type | Source | Status |
|-----|------|--------|--------|
| **Claude.app** | GUI | Cask | ✅ Essential |
| **claude-code** | CLI | Cask | ✅ Essential |
| **Codex** | CLI | Cask | ✅ Essential |
| **ChatGPT** | GUI | Direct | ✅ Essential |
| **gemini-cli** | CLI | Homebrew | ✅ Essential |
| **opencode** | CLI | Homebrew | ✅ Essential |
| **amp** | CLI | TBD | ✅ Essential |

### Development

| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **VS Code** | Cask | ✅ Used | Editor |
| **Xcode** | App Store | ✅ Used | Swift/iOS |
| **OrbStack** | Cask | ✅ Essential | Docker/containers |
| **Zed** | Direct | ✅ Used | Editor |
| **WezTerm** | Cask | ✅ Used | Backup terminal / used with Ghostty |
| Cursor | Cask | ⚪ Optional | AI IDE, not critical |
| GitHub Desktop | Direct | ⚪ Rarely used | Prefer CLI |
| iTerm | Cask | ❌ Not used | Remove |
| Warp | Cask | ❌ Not needed | Remove |
| Kiro | ? | ❌ Not needed | Remove |

### Communication

| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **Microsoft Teams** | Cask | ✅ Work | Required for work |
| **Zoom** | Cask | ✅ Work | Required for work |
| Telegram | Cask | ⚪ Rarely used | Good to have |
| WhatsApp | Cask | ⚪ Rarely used | Good to have |
| Discord | Cask | ⚪ Rarely used | Good to have |

### Productivity

| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **1Password** | App Store | ✅ Essential | See Critical section |
| Linear | Cask | ⚪ Considering | Project management |
| Drafts | App Store | ❌ Not used | Remove |
| iA Writer | App Store | ❌ Not used | Remove |

### Utilities

| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **HyprSpace** | Cask | ✅ Essential | Main window manager |
| **Shottr** | Cask | ✅ Essential | Screenshots |
| **Leader Key** | Cask | ✅ Used | Keyboard shortcuts |
| **noTunes** | Cask | ✅ Used | Block Apple Music (hidden) |
| **Pearcleaner** | Cask | ✅ Used | App uninstaller |
| **LocalSend** | Cask | ✅ Used | File transfer |
| OmniWM | Cask | ⚪ Testing | Potential Hyperspace replacement |
| Karabiner-Elements | Cask | ⚪ To be used | Keyboard remapping |
| MacWhisper | Cask | ❌ Not used | Remove |

### Media

| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **VLC** | Cask | ✅ Used | Video player |
| **Spotify** | Direct | ✅ Used | Music |
| **calibre** | Direct | ✅ Used | eBooks |
| HandBrake | Cask | ❌ Not used | Remove |
...
| App | Source | Status | Notes |
|-----|--------|--------|-------|
| **BambuStudio** | Direct | ✅ Used | 3D printing |
| **Rhino 8** | Direct | ✅ Keep | 3D modeling |
| **SketchUp 2026** | Direct | ✅ Keep | 3D modeling |
| KiCad | Cask | ⚪ Keep | PCB design |

### Other Keep

| App | Source | Notes |
|-----|--------|-------|
| IPTV Expert/Pro | App Store | Used |
| kindaVim | Direct | Keep for now |
| Leash | Cask | Keep |
| NayaFlow | Direct | Keep |
| Stremio | Direct | Streaming |
| Antinote | Direct | Rarely used |
| Alacritty | Cask (deprecated) | Backup terminal |

### Remove / Cruft

| App | Reason |
|-----|--------|
| Arc | No longer maintained, switched to Chrome |
| Chromium | Deprecated cask, not used |
| PowerShell | Deprecated cask, not used |
| Syntax Highlight | Deprecated, need alternative |
| ChatGPT Atlas | Not used |
| BookMacster | Not used |
| Conductor | Not used |
| Goose | Not used |
| `log_iotc.txt` | Stray file in /Applications |

### Summary

- **Essential (must install):** ~25 apps
- **Used regularly:** ~15 apps
- **Keep but optional:** ~10 apps
- **Remove:** ~10 apps
...
- [ ] Test on Linux VM (Omarchy - DHH's Linux distro, github.com/basecamp/omarchy)
