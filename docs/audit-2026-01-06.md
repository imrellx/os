...
| TypeScript | **Bun** (runtime + package manager) | Primary tooling |
| JavaScript | **Bun** (runtime + package manager) | Primary tooling |
...
### Cleanup Needed
- [ ] Remove nvim config aliases for astrovim, adibhanna, cpplain (keeping LazyVim only)
...
| nvim-lazyvim/ | Primary editor | **Only neovim config to keep** |
| git/ | Git config | |
...
| Directory | Reason |
|-----------|--------|
| nvim-adibhanna/ | Not used, keeping LazyVim only |
| nvim-astrovim/ | Not used |
| nvim-cpplain/ | Not used |
| nvim/ | Empty/unused |
| alacritty/ | Deprecated cask, removing |
| aerospace/ | Using Hyperspace instead |
...
- [ ] Clean up unused nvim configs (keep only lazyvim)
